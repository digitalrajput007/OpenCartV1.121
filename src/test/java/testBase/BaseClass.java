...
public class BaseClass{
	...
	public void setup(String br, String os) throws IOException {
		...
		if (p.getProperty("execution_env").equalsIgnoreCase("remote")) {
			...
			default : System.out.print("Invalid browser name"); break;
			}
			System.out.println("Launching on remote selenium grid....");
			driver= new RemoteWebDriver(new java.net.URL("http://localhost:4444/wd/hub"), capabilities);
		...
		if(p.getProperty("execution_env").equalsIgnoreCase("local")) {
			...
			default : System.out.print("Invalid browser input..");return;
			}
	...
	public String randompass() {
		...
		return (generatenum+"@"+generateString);
	}
